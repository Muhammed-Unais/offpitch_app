...
SingleTournamentModel singleTournamentModelFromJson(
        Map<String, dynamic> data) =>
    SingleTournamentModel.fromJson(data);

String singleTournamentModelToJson(SingleTournamentModel data) =>
...
class SingleTournamentModel {
  ...
  factory SingleTournamentModel.fromJson(Map<String, dynamic> json) =>
      SingleTournamentModel(
        success: json["success"],
        message: json["message"],
        data: json["data"] == null
            ? null
            : TournamentDetailsData.fromJson(json["data"]),
      );
...
class TournamentDetailsData {
  ...
  factory TournamentDetailsData.fromJson(Map<String, dynamic> json) =>
      TournamentDetailsData(
        id: json["_id"],
        ...
        teams: json["teams"] == null
            ? []
            : List<DataTeam>.from(
                json["teams"]!.map((x) => DataTeam.fromJson(x))),
...
class Matches {
  ...
  factory Matches.fromJson(Map<String, dynamic> json) => Matches(
        id: json["_id"],
        host: json["host"],
        cMatch: json["c_match"] == null
            ? []
            : List<int>.from(json["c_match"]!.map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "host": host,
        "c_match":
            cMatch == null ? [] : List<dynamic>.from(cMatch!.map((x) => x)),
        "rounds": rounds == null
            ? []
...
class Team {
  ...
  factory Team.fromJson(Map<String, dynamic> json) => Team(
        ...
        scorer: json["scorer"] == null
            ? []
            : List<dynamic>.from(json["scorer"]!.map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "goals": goals,
        "scorer":
            scorer == null ? [] : List<dynamic>.from(scorer!.map((x) => x)),
      };
}
