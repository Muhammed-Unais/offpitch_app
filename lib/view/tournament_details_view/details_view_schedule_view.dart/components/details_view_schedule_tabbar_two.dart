...
class DetaildViewScheduledTabbarTwo extends StatelessWidget {
  const DetaildViewScheduledTabbarTwo(
    ...
    return Column(
      children: [
        ...
        DetailsViewShortDescription(
            shortDescription: singleTournamentModel.data!.shortDescription!),
        DetailsViewDateTime(
