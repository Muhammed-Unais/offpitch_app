...
class AddPlayerBottomSheet {
  static showBottomAddPlayer(
    ...
    final myClubprovider = Provider.of<MyClubPlayerAddViewModel>(context, listen: false);
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    margin:
                        const EdgeInsets.symmetric(vertical: AppMargin.large),
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          if (formKey.currentState!.validate() &&
                            ...
                            myClubprovider
                                .setBorderError(Border.all(color: Colors.red));
